                        ...
                        if (dataSnapshot.exists()) {
                            for (DataSnapshot eventSnapshot : dataSnapshot.getChildren()) {
                                ...
                                if (sportTitle.equals("") ||
                                    ...
                                    Toast.makeText(getApplicationContext(), "Boş alanları doldurun,lütfen!", Toast.LENGTH_LONG).show();
                                } else {
                                    ...
                                    Toast.makeText(getApplicationContext(), "Başarılı bir şekilde yeni spor etkinliği olşuturdunuz", Toast.LENGTH_LONG).show();
                                    clearForm();
                                    finish();
                                }
                            }
    ...
    private void getAddress() {
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onError(Status status) {
                System.out.println("Otomatik tamamlama formundan alma adresinde bir hata oluştu: " + status);
            }
        });
    }
    ...
    private void setUpTime() {
        ...
        selectTimeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                newFragment.show(getFragmentManager(), "Zaman");
            }
        });
    }
