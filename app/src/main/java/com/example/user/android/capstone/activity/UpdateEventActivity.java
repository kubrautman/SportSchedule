        ...
        mUpdateEventButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (sportTitle.equals("") ||
                        sportDetails.equals("") ||
                        placeAddress.equals("")) {
                    Toast.makeText(getApplicationContext(), "Bol alanları doldurun,lütfen!", Toast.LENGTH_LONG).show();
                } else {
                    ...
                    Toast.makeText(getApplicationContext(), "Başarılı bir şekilde spor etkinliğini güncellediniz", Toast.LENGTH_LONG).show();
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog picker = new DatePickerDialog(UpdateEventActivity.this, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datePicker, int i, int i1, int i2) {
                        ...
                        if (monthString == null) {
                            showDateTextView.setText("Tarih Seçilmedi");
                        } else {
