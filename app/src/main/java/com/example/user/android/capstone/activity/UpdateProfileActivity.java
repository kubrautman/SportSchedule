...
public class UpdateProfileActivity extends AppCompatActivity {
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(getApplicationContext(), "Kullanıcı hesabı başarıyla silindi", Toast.LENGTH_LONG).show();
    ...
    private void updateUserInfo(String userId) {
        ...
        if (email.equals("") ||
            ...
            Toast.makeText(getApplicationContext(), "Profil bilgileriniz başarılı bir şekilde güncellendi", Toast.LENGTH_LONG).show();
