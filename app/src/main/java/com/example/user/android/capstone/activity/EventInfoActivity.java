...
public class EventInfoActivity extends AppCompatActivity {
        ...
        mParticipateInEventButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (count >= 1) {
                    ...
                    Toast.makeText(getApplicationContext(), "Etinlik dolu", Toast.LENGTH_LONG).show();
                }
    ...
    private void updateAttendeesCount(boolean increaseCount, Event event) {
        int count = Integer.parseInt(event.getPeopleNeeded());
        if (!increaseCount) {
            mEventsRef.child(eventId).child("Gerekli insan").setValue(count - 1);
    ...
    private void updateEventUI(Event e1) {
        ...
        if (Integer.parseInt(e1.getPeopleNeeded()) == 0) {
            mEventInfoPeopleNeeded.setText("Dolu");
            ...
            if (Integer.parseInt(e1.getPeopleNeeded()) == 1) {
                mEventInfoPeopleNeeded.setText(e1.getPeopleNeeded() + " Kişi");
            } else {
                mEventInfoPeopleNeeded.setText(e1.getPeopleNeeded() + " Kişi");
            }
    ...
    private void setUpRecycleViewForUserList(List<User> eventUsers) {
        ...
        if (count == 0) {
            mPeopleCountTextView.setText("Bu etkinliğe ilk siz katılın");
        } else if (count == 1) {
            mPeopleCountTextView.setText(count + " kişi gidiyor");
        } else {
            mPeopleCountTextView.setText(count + " kişi gidiyor");
        }
        ...
        currentEvent.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChild("rating")) {
                    ...
                    txtRatingValue.setText("Geçerli oylama: " + formattedValue);
                    ...
                    txtRatingValue.setText("İlk oyu siz verin!");
                }
            }
                ...
                currentEvent.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(EventInfoActivity.this,
                                "Bu etkinliğe oy verdiğiniz için teşekkürler",
                                Toast.LENGTH_SHORT).show();
                        mRateEventButton.setVisibility(View.GONE);
                        String formattedValue = String.format("%.2f", newRatingValue);
                        txtRatingValue.setText("Geçerli oylama: " + ratingValue);
                    }
